...
export default async function SkillsPage() {
  ...
  const handleRequestSwap = (skillId: number, skillTitle: string) => {
    // Note: This would typically be handled by a client component
    console.log(`Requesting swap for skill ID: ${skillId}, Title: ${skillTitle}`);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Discover amazing skills from our community and connect with talented individuals. 
            Find the perfect skill swap partner to accelerate your learning journey.
          </p>
